...
arc_trm.py (does NOT use custom object file)
visualise_predictions_trm.py (generates results in visualisations_trm_graph folder)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Does NOT use builder custom_object3.py
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
