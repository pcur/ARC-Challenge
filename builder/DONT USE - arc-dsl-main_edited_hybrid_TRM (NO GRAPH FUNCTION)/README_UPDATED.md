...
arc_trm_hybrid.py (does NOT use custom object file)
visualise_predictions_trm_hybrid.py (generates results in visualisations_trm_graph folder)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Does NOT use builder hybrid_object2.py
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
