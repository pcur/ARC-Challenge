...
arc_trm_graph.py (train with TRM using custom_object3.py)
visualise_predictions_trm_graph_hybrid.py (generates results in visualisations_trm_graph folder)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Using builder custom_object3.py
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Test builder by running run_builder_custom_object.py
