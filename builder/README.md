Only need to run the following folder:

    - arc-dsl-main_edited_custom_TRM_Graph --> more nodes and edges
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Can run this folder if interested:

    - arc-dsl-main_edited_hybrid_TRM_Graph (less features) --> fewer nodes and edges
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Once files uploaded read the README_UPDATED.md file for instructions on how to test builder and trm
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DO NOT NEED TO OPEN THE FOLLOWING FOLDERS:

    - DONT USE - arc-dsl-main_edited_custom_TRM  (NO GRAPH FUNCTION)  --> TRM being used without custom object function
    - DONT USE - arc-dsl-main_edited_hybrid_TRM (NO GRAPH FUNCTION)  --> TRM being used without hybrid object function
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
